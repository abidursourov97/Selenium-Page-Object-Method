...
public class CommonMethods {
    ...
    public class CommonMethod{
        ...
        public void hoverOverElement(WebElement element) {
            new Action(PageDriver.getCurrentDriver()).moveToElement(element).perform();
        }
        ...
        private WebDriverWait wait = new WebDriverWait(PageDriver.getCurrentDriver(), Duration.ofSeconds().ofSeconds(30));
